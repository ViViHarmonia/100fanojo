...
export const sections = [
  { label: "Color Pages", tag: "color", desc: "" },
  { label: "Covers/Backs", tag: "cover", desc: "" },
  { label: "Date Artwork", tag: "date", desc: "" },
  { label: "Character Sheets", tag: "sheet", desc: "" },
  { label: "Sketches", tag: "sketch", desc: "" },
  { label: "Anime Art", tag: "anime", desc: "" },
  { label: "Promo Art", tag: "promo", desc: "" },
  { label: "B-Day Art", tag: "bday", desc: "" },
  { label: "Black & White", tag: "b&w", desc: "" },
  { label: "Light Novel", tag: "light", desc: "" },
  { label: "Bonus Art", tag: "bonus", desc: "" },
  { label: "Chibis", tag: "chibi", desc: "" },
  {
  ...
  { label: "Merchandise/Collab", tag: "colab", desc: ""  },
  { label: "Pajamas", tag: "pj", desc: ""  },
  { label: "Puzzle Game", tag: "game", desc: ""  },
  { label: "Swimsuits", tag: "swim", desc: ""  },
  { label: "Art by Others", tag: "other", desc: ""  },
];
